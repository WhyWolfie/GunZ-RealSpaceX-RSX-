...
/*
    Source alteration (28/02/2014)
    - Added uncompressedSize_ parameter
*/
Result Decompressor::decompress(const void* source, size_t sourceSize, void* destination, size_t destinationSize, size_t& uncompressedSize)
{
	assert(source != 0);
    ...
    /*
        Source alteration (28/02/2014)
        - Added uncompressedSize parameter
    */

	uncompressedSize = static_cast<size_t>(header.uncompressedSize);
